...
#[carbon(discriminator = "0xcebdd0a61351ca30")]
pub struct AdminDepositMsol{
    pub version: u16,
    pub amount: u64,
}

#[derive(Debug, PartialEq, Eq, Clone, Hash, serde::Serialize, serde::Deserialize)]
pub struct AdminDepositMsolInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for AdminDepositMsol {
    type ArrangedAccounts = AdminDepositMsolInstructionAccounts;
    ...
    fn arrange_accounts(accounts: &[solana_instruction::AccountMeta]) -> Option<Self::ArrangedAccounts> {
        ...
        Some(AdminDepositMsolInstructionAccounts {
