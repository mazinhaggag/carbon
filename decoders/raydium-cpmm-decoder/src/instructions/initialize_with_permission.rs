...
impl carbon_core::deserialize::ArrangeAccounts for InitializeWithPermission {
    ...
    fn arrange_accounts(accounts: &[solana_instruction::AccountMeta]) -> Option<Self::ArrangedAccounts> {
        ...
        Some(InitializeWithPermissionInstructionAccounts {
            ...
            payer_token_0: payer_token_0.pubkey,
            payer_token_1: payer_token_1.pubkey,
            payer_lp_token: payer_lp_token.pubkey,
            ...
            token_0_program: token_0_program.pubkey,
            token_1_program: token_1_program.pubkey,
