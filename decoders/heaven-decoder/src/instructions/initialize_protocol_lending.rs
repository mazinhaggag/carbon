...
#[carbon(discriminator = "0x00cdedf01b4f1b3b")]
pub struct InitializeProtocolLending{
    pub version: u16,
    pub recent_slot: u64,
}

#[derive(Debug, PartialEq, Eq, Clone, Hash, serde::Serialize, serde::Deserialize)]
pub struct InitializeProtocolLendingInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for InitializeProtocolLending {
    type ArrangedAccounts = InitializeProtocolLendingInstructionAccounts;
    ...
    fn arrange_accounts(accounts: &[solana_instruction::AccountMeta]) -> Option<Self::ArrangedAccounts> {
        ...
        Some(InitializeProtocolLendingInstructionAccounts {
